...
// LEGACY REFERENCE COPY — preserved as-is, not wired into routing or vercel.json.
// This is the marketplace order Checkout Session flow (delivery/shipping fee line item +
// Stripe Connect transfer_data/application_fee_amount seller payout split). The live version
// remains active and unmodified at api/create-order-checkout.js; this file exists purely so the
// delivery + transfer-charge logic can be restored/reused later without digging through git history.
