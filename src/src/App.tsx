...
// 🟦 1. Enhanced Blueprint Validation Data Schema
interface DeckItem {
    id: number;
    title: string;
    ...
    location: string;
    sellerEmail: string;
    imagePreview: string[]; // Holds up to 3 gallery images
    courier: string;
    shippingCost: string;
    qrTracking: boolean;
...
export default function App() {
    ...
    // 🔮 Home Entry Portal Component with Multi-Tab Auth
    const Home = () => {
    ...
    // 🟦 Listings Catalog Grid View Component
    const ListingsView = () => {
        return (
            <div className="listings-container">
                ...
                <div className="deck-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '24px' }}>
                    {listings.map((deck) => (
...
// ========================================================
// 🛠️ STANDALONE UTILITY SUB-COMPONENTS
// ========================================================
